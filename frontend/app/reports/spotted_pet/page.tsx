...
export default function Spotted_Pet_Page(){
    ...
    function handleSubmit(e: React.SyntheticEvent<HTMLFormElement>) {
        ...
        setError("");
        if (files.length === 0) {
            setError("Please upload at least one photo of spotted pet.");
            return;
        }
        ...
        if (!date) {
            setError("Please select the date when you spotted the pet.");
            return;
        }
        if (!time) {
            setError("Please select the time when you spotted the pet.");
            return;
        }

        setIsPending(true);
        const formData = new FormData();
        formData.append("type", 'SPOTTED');
        ...
        console.log({files,location,date,time,description,});
    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-white">
        ...
        <form onSubmit={handleSubmit} className="bg-white w-full px-4 text-black border-b-2 border-gray-400 pb-4">
            ...
            <div className="flex flex-col my-2 mx-1 gap-1">
                <p className="font-bold text-sm">Last Location</p>
            ...
            <div className="flex justify-center m-4">
                <button type="submit" disabled={isPending} className="bg-orange-500 min-w-1/2 p-4 px-8 flex justify-center gap-8 rounded-xl hover:shadow-xl">
                    <p className="text-white font-bold">Report Spotted Pet</p>
